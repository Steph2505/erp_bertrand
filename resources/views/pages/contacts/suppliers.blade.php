                ...
                <tr>
                    ...
                    <td>
                        <div class="data-table__actions">
                            ...
                            <form method="POST" action="{{ route('suppliers.destroy', $supplier) }}" @submit.prevent="window.confirmDialog('Supprimer ce fournisseur ?', {variant:'danger', confirmLabel:'Supprimer'}).then(ok => ok && $el.submit())">
                                @csrf @method('DELETE')
