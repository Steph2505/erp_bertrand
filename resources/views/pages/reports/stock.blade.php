...
<div class="stat-grid" style="margin-bottom:20px;">
    ...
    <div class="stat-card"><div class="stat-card__info"><div class="stat-card__label">Stock faible</div><div class="stat-card__value" style="color:#F59E0B;">{{ $lowCount }}</div><div class="stat-card__trend stat-card__trend--down">Sous le minimum</div></div><div class="stat-card__icon stat-card__icon--yellow"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z"/></svg></div></div>
    <div class="stat-card"><div class="stat-card__info"><div class="stat-card__label">Rupture</div><div class="stat-card__value" style="color:#EF4444;">{{ $outCount }}</div><div class="stat-card__trend stat-card__trend--down">Stock = 0</div></div><div class="stat-card__icon stat-card__icon--red"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636"/></svg></div></div>
</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:right;font-weight:600;color:{{ $isOut?'#EF4444':($isLow?'#F59E0B':'#22C55E') }}">{{ \App\Helpers\FormatHelper::number($p->stock_quantity) }}</td>
