                    ...
                    <td>
                        <div class="data-table__actions">
                            ...
                            @else
                                ...
                                <form method="POST" action="{{ route('expenses.destroy', $row->id) }}" @submit.prevent="window.confirmDialog('Supprimer cette dépense ?', {variant:'danger', confirmLabel:'Supprimer'}).then(ok => ok && $el.submit())">
                                    @csrf @method('DELETE')
