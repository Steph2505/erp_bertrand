...
<div class="stat-grid" style="margin-bottom:24px;">
    <div class="stat-card">
        <div class="stat-card__info"><div class="stat-card__label">TVA collectée</div><div class="stat-card__value" style="color:#12864B;">{{ \App\Helpers\FormatHelper::money($totalCollected) }}</div><div class="stat-card__trend stat-card__trend--flat">Sur ventes confirmées</div></div>
    ...
    <div class="stat-card">
        <div class="stat-card__info"><div class="stat-card__label">TVA déductible</div><div class="stat-card__value" style="color:#1749B3;">{{ \App\Helpers\FormatHelper::money($totalDeductible) }}</div><div class="stat-card__trend stat-card__trend--flat">Sur achats confirmés</div></div>
    ...
    <div class="stat-card">
        <div class="stat-card__info">
            ...
            <div class="stat-card__value" style="color:{{ $taxDue>=0?'#C4231A':'#12864B' }}">{{ \App\Helpers\FormatHelper::money($taxDue) }}</div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right;font-weight:600;color:#12864B;">{{ \App\Helpers\FormatHelper::money($row->tax_amount) }}</td>
                </tr>
                @empty
                ...
                <tr style="border-top:2px solid #E2E8F0;font-weight:700;">
                    <td>TOTAL</td><td></td><td style="text-align:right;color:#12864B;">{{ \App\Helpers\FormatHelper::money($totalCollected) }}</td>
                </tr>
                @endif
            </tbody>
        </table>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right">{{ \App\Helpers\FormatHelper::money($row->base) }}</td>
                    <td style="text-align:right;font-weight:600;color:#1749B3;">{{ \App\Helpers\FormatHelper::money($row->tax_amount) }}</td>
                </tr>
                @empty
                <tr><td colspan="3" style="text-align:center;padding:24px;color:#64748B;">Aucune TVA sur la période</td></tr>
                @endforelse
                ...
                <tr style="border-top:2px solid #E2E8F0;font-weight:700;">
                    <td>TOTAL</td><td></td><td style="text-align:right;color:#1749B3;">{{ \App\Helpers\FormatHelper::money($totalDeductible) }}</td>
                </tr>
                @endif
            </tbody>
        </table>
