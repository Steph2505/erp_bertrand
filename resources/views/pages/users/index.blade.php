                ...
                <tr>
                    ...
                    <td>
                        <div class="data-table__actions">
                            ...
                            <form method="POST" action="{{ route('users.destroy', $user) }}" @submit.prevent="window.confirmDialog('Supprimer cet utilisateur ?', {variant:'danger', confirmLabel:'Supprimer'}).then(ok => ok && $el.submit())">
                                @csrf @method('DELETE')
