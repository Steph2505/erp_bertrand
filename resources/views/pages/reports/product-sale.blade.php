...
<div class="table-wrapper">
    ...
    <table class="data-table">
        ...
        @php $totalRevenue = $items->sum('total_revenue'); @endphp
        <tbody>
            @forelse($items as $i => $item)
            @php $share = $totalRevenue > 0 ? ($item->total_revenue / $totalRevenue * 100) : 0; @endphp
            <tr>
                ...
                <td style="text-align:right;font-weight:600;color:#22C55E;">{{ \App\Helpers\FormatHelper::money($item->total_revenue) }}</td>
