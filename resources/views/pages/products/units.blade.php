            ...
            <tr>
                ...
                <td>
                    <div class="data-table__actions">
                        ...
                        <form method="POST" action="{{ route('units.destroy', $unit) }}" @submit.prevent="window.confirmDialog('Supprimer cette unité ?', {variant:'danger', confirmLabel:'Supprimer'}).then(ok => ok && $el.submit())">
                            @csrf @method('DELETE')
