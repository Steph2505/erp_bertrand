...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            // Entreprise
            ['company_name',     'Bertrand Store',                                              'company'],
            ['company_address',  'Cameroun, Centre-Yaoundé, Etoudi',              'company'],
            ['company_phone',    '+225 27 20 00 00 00',                                            'company'],
            ['company_email',    'contact@bertrand-store.ci',                                   'company'],
            ['company_tax_id',   'xxx',                                            'company'],
            ['company_website',  'https://bertrand-store.ci',                                   'company'],
