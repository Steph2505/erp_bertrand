    ...
    <div class="auth-form-panel">
        ...
        <div class="auth-form-panel__form">
            ...
            <form method="POST" action="{{ route('login') }}" x-data="{ showPassword: false }">
                ...
                @if ($errors->any())
                    {{-- Message générique, jamais rattaché à un champ précis : on ne
                         doit pas indiquer si c'est l'email ou le mot de passe qui est
                         en cause, pour ne pas faciliter une attaque par énumération. --}}
                    <div class="alert alert--danger mb-16">
                        <div class="alert__content">{{ $errors->first() }}</div>
                    </div>
                @endif
