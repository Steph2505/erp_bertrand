...
<head>
    ...
    <style>
        * { margin:0;padding:0;box-sizing:border-box; }
        ...
        .invoice-label { font-size:30px;font-weight:900;color:#1749B3;letter-spacing:-.5px; }
        .invoice-meta { text-align:right;font-size:13px;color:#64748B;margin-top:6px; }
        .invoice-meta strong { color:#0E1726; }
        .divider { height:2px;background:linear-gradient(to right,#1749B3,#22c55e);margin:24px 0;border-radius:2px; }
        ...
        .totals-row.total span:last-child { color:#1749B3; }
...
<div class="page">
    ...
    <div class="no-print" style="text-align:right;margin-bottom:20px;display:flex;gap:8px;justify-content:flex-end;">
        <button onclick="window.print()" style="padding:10px 20px;background:#1749B3;color:#fff;border:none;border-radius:8px;cursor:pointer;font-size:13px;font-weight:600;">
            🖨️ Imprimer
        </button>
